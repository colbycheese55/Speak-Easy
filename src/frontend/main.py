...
labelIn = ctk.CTkLabel(rightPanel, text="Input Language", font=satoshiBold, pady=10)
...
labelOut = ctk.CTkLabel(rightPanel, text="Output Language", font=satoshiBold, pady=10)
